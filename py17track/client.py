...
class Client:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, *, version: Version = Version.LEGACY, session: Optional[ClientSession] = None) -> None:
        """Initialize."""
    ...
    def profile(self):
        ...
        if not self._profile:
            if self._version == Version.LEGACY:
                warnings.warn("Legacy API has been deprecated, please update to V1", DeprecationWarning, stacklevel=2)
